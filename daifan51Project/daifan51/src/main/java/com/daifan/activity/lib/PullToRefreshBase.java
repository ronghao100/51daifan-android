package com.daifan.activity.lib;
...
import com.daifan.R;
import com.daifan.activity.lib.internal.LoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.PullToRefresh_PTRheaderBackground)) {
            this.setBackgroundResource(a.getResourceId(R.styleable.PullToRefresh_PTRheaderBackground, Color.WHITE));
        }
